class Config(object):
    ...
    model_storage_dir = './model_storage/add_pseudo_label'
    checkpoint_path = './model_storage/add_pseudo_label/finetuned_model_epoch15.bin'
